...
// product imgs - each import resolves to final img url
...
import imgGuetemalaAntigua from "../assets/Guatemala-Antigua-Bag.png";
...
export default function ProductShowCase() {
    return (
        <div className="product-showcase">
            ...
            {/* product grip, cards cascade in 0.1s apart */}
                ...
                {products.map((product) => (
                    ...
                    <StaggerItem key={product.name}>
                        <motion.div
                            ...
                            // lift box while hovered so card feels clickable
